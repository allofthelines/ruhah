    ...
    if request.user.is_authenticated:
        ...
        filtered_tickets = [ticket for ticket in ticket_list if
                            ...
                            (ticket.stylist_type == 'everyone' or
                                (ticket.stylist_type == 'following' and ticket.creator_id and ticket.creator_id.id in following_user_ids)) # ...kalyptei o ticket creator na exei valei stylist == following
                            ]
